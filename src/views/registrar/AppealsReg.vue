...
methods:{
    ...
    proceed:function(){
        if(this.currentStatus === "Approved"){
            axios.put(`http://localhost:8086/api/academics/appeals/registrar/${this.id}/approve`)
            .then(() => {
            ...
            axios.put(`http://localhost:8086/api/academics/appeals/registrar/${this.id}/deny`)
            .then(() => {
                this.message="Successfully updated!"
                this.error = "";
            })
    ...
    getAppeals:function(){
        axios.get("http://localhost:8086/api/academics/appeals/registrar/get/all")
        .then(Response => {
            this.results = Response.data.appeals.map(item => {
                    return item;
                })
        })
    }
