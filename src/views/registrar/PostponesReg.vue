...
methods:{
    ...
    proceed:function(){
        if(this.currentStatus === "Approved"){
            axios.put(`http://localhost:8086/api/academics/postpones/registrar/${this.id}/approve`)
            .then(() => {
            ...
            axios.put(`http://localhost:8086/api/academics/postpones/registrar/${this.id}/deny`)
            .then(() => {
                this.message="Successfully updated!"
                this.error = "";
            })
    ...
    getPostpones:function(){
        axios.get("http://localhost:8086/api/academics/postpones/registrar/get/all")
        .then(Response => {
